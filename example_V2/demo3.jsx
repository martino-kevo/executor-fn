...
export default function ExecutorV2MegaDemo() {
    ...
    return (
        <div style={{ padding: "2rem", fontFamily: "sans-serif" }}>
            ...
            <p>Entries added: {progress.toLocaleString()} / {totalEntries.toLocaleString()}</p>
            ...
            <div style={{ margin: "1rem 0" }}>
                ...
                <button onClick={handleJumpToEnd} style={{ marginRight: "0.5rem" }}>Jump to End</button>
                <button onClick={handleSplit} style={{ marginRight: "0.5rem" }}>Split 2 Ranges</button>
                <button onClick={handleMerge}>Merge Last 20k</button>
            </div>

            <div style={{ marginTop: "1rem", fontSize: "0.9rem", color: "#666" }}>
                Memory buffer: last 5000 entries in RAM. IndexedDB persists full 1M history. Undo/Redo is near-instant for recent entries.
            </div>
        </div>
    );
}
